...
class sncp_comum_codigos_contab(osv.Model):
    ...
    _columns = {
        ...
        'code': fields.related('item_id', 'default_code', type="char", store=True, string=u"Código"),
        'ean13': fields.related('item_id', 'ean13', type="char", store=True, string=u'Código EAN'),
        'natureza': fields.selection([('rec', u'Receita Orçamental'),
                                      ('des', u'Despesa Orçamental'),
                                      ('ots', u'Operações de tesouraria')], u'Natureza'),
        'name': fields.related('item_id', 'name_template', type="char", store=True, string=u'Nome'),
