...
class sncp_despesa_compromisso_ano(osv.Model):
    ...
    _columns = {
        ...
        'tipo_comp': fields.related('compromisso_id', 'tipo', type="char", store=True),
        ...
        'next_comp': fields.related('compromisso_id', 'next', type="integer", store=True),
        'state_comp': fields.related('compromisso_id', 'state', type="char", store=True),
    }
...
class sncp_despesa_compromisso_linha(osv.Model):
    ...
    _columns = {
        ...
        'tipo_comp': fields.related('compromisso_ano_id', 'compromisso_id', 'tipo', type="char", store=True),
        'state_comp': fields.related('compromisso_ano_id', 'compromisso_id', 'state', type="char", store=True),
        'estado_ano': fields.related('compromisso_ano_id', 'estado', type="integer", store=True),
