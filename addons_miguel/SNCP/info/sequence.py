...
class ir_sequence(openerp.osv.osv.osv):
    ...
    _columns = {
        ...
        'number_increment': openerp.osv.fields.integer('Increment Number', required=True,
                                                       help="The next number of the sequence will be incremented "
                                                            "by this number"),
        'padding' : openerp.osv.fields.integer('Number Padding', required=True, help="OpenERP will automatically adds "
                                                                                     "some '0' on the left of the "
                                                                                     "'Next Number' to get the "
    ...
    def _next(self, cr, uid, seq_ids, context=None):
        ...
        sequences = self.read(cr, uid, seq_ids, ['company_id', 'implementation', 'number_next', 'prefix', 'suffix',
                                                 'padding'])
