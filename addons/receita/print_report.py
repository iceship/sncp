...
from ..base_report_to_printer import report_service
from ..base_report_to_printer.report_service import  original_exp_report
                ...
                try:
                    ...
                    # Bloco de envio da carta em papel
                        ...
                        if obj_param.crr_notifica:
                            ...
                            vrs = original_exp_report(name='report')
                            ...
                            report_service.exp_report_get(vrs, cr.dbname, uid, 1)
                    # Conclusão
