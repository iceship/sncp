...
openerp.receita = function (instance) {
    ...
    instance.web.views.add('tree_pesquisa_departamento', 'instance.web.receita.PesquisaDepartamentoListView');
    instance.web.receita.PesquisaDepartamentoListView = instance.web.ListView.extend({
        init:function(){
        ...
        start:function(){
            ...
            var self = this;
            var defs = [];
            this.$el.parent().prepend(QWeb.render("PesquisaDepartamento", {widget: this}));
